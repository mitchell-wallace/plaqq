...
// legible, compact 5-row face. This is plaqq's original, field-tested block
// font — the wider re-authored variant lives separately as "wide". It is the
// workhorse face and the authoring pattern the other fonts follow.
//
// Provenance / licence: hand-authored for plaqq (MIT). Letter shapes themselves
// are not copyrightable; the specific renderings are.
//
